  ...
  return (
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="p-5">
      <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <Card style={{ marginTop: 12 }}>
          <Text style={{ color: colors.foreground, fontSize: 18, fontWeight: "800" }}>Language</Text>
          <Text style={{ color: colors.muted, marginTop: 5, lineHeight: 20 }}>Choose labels and number formatting for supported physics content. Equations and SI units stay unchanged.</Text>
