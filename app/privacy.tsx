...
import { buildLocalDataShareText, clearAllLocalData, formatLocalDataSummary, formatPrivacyActivityTimestamp, getLocalDataSummary, loadPrivacyActivity, localSummaryFileUri, recordPrivacyActivity, type LocalDataSummary, type PrivacyActivityEvent } from "@/lib/privacy";
  ...
  const share = async () => {
    ...
    try {
      if (Platform.OS === "web" || !(await Sharing.isAvailableAsync())) {
        ...
        await loadPrivacyActivity().then(setActivity).catch(() => undefined);
