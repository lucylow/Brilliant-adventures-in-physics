...
export default function PracticeScreen() {
  ...
  const submit = () => { Keyboard.dismiss(); const numeric = Number(answer.replace(",", ".")); const isCorrect = checkNumericAnswer(numeric, expected); setFeedback(isCorrect ? "correct" : "incorrect"); void recordAttempt(isCorrect, question.concept); void deleteDraft("practice"); };
  const next = () => { setIndex((value) => value + 1); setAnswer(""); setFeedback(null); setHint(false); void deleteDraft("practice"); };
