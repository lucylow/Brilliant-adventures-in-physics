...
export default function PracticeScreen() {
  ...
  const next = async () => { if (submitting) return; setIndex((value) => value + 1); setAnswer(""); setFeedback(null); setHint(false); const deleted = await persistSafely(deleteDraft("practice")); setPersistenceMessage(localizedPersistenceMessage(deleted)); };
