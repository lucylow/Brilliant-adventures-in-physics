...
export default function PracticeScreen() {
  ...
  const saveToNotebook = async () => { const result = await persistSafely(saveNotebookEntry({ title: `${question.concept} practice`, type: "experiment", content: `${question.prompt} Verified answer: ${expected.toFixed(2)} ${question.unit}.`, links: [question.concept] })); setNotebookMessage(result.ok ? tr("practice.savedNotebook") : persistenceRecoveryMessage(result)); };
