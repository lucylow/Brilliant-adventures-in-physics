...
describe("mock dataset volume and integrity", () => {
  it("builds a deterministic demo pack that meets catalog floors", () => {
    ...
    expect(first.concepts.length).toBeGreaterThanOrEqual(100);
    expect(first.lessons.length).toBeGreaterThanOrEqual(50);
    expect(first.problems.length).toBeGreaterThanOrEqual(100);
    expect(first.simulations.length).toBeGreaterThanOrEqual(20);
    expect(first.missions.length).toBeGreaterThanOrEqual(20);
    expect(first.achievements.length).toBeGreaterThanOrEqual(20);
    expect(first.experiments.length).toBeGreaterThanOrEqual(20);
    expect(first.tutorSessions.length).toBeGreaterThanOrEqual(25);
    expect(first.attempts.length).toBeGreaterThanOrEqual(100);
    expect(first.mastery.length).toBeGreaterThanOrEqual(20);
